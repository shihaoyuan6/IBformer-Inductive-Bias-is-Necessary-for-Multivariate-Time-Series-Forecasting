...
from layers.RC import RecurrentCycle
...
class series_decomp_multi(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.cycleQueue = RecurrentCycle(cycle_len=args.cycle, channel_size=args.enc_in)

        self.use_revin= True
        self.seq_len = args.seq_len
        self.pred_len = args.pred_len
        self.cycle_len = args.cycle
    ...
    def forward(self, x, cycle_index):
        ...
        y= self.cycleQueue(cycle_index, self.seq_len)
        res = x - y
        return  y, res
