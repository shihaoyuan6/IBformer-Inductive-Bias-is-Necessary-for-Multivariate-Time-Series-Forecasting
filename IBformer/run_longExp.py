...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='IBformerTST_Points_ALL',
                        help='model name, options: [Autoformer, Informer, Transformer, Keyformer]')
    ...
    #Cyclical
    #parser.add_argument('--cycle', type=int, default=96, help='cycle length')
    # DLinear
